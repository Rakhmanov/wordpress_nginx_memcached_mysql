...
-- Dumping data for table wordpress.wp_options: ~101 rows (approximately)
...
-- Dumping data for table wordpress.wp_posts: ~3 rows (approximately)
...
-- Dumping data for table wordpress.wp_usermeta: ~15 rows (approximately)
